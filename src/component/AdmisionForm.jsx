...
const handlePrint = () => {
        ...
        <head>
            ...
            <style>
                ...
                .sheet-container {
                    ...
                    padding: 5mm;
                    min-height: 135mm;   /* Flexible height */
                    position: relative;
                    display: flex;
    ...
    const DocumentSheet = ({ copyName }) => (
        <div className="sheet-container">
            ...
            {/* Row 2: Main Details Table - Compact padding */}
            ...
            {/* Row 3: Docs & Subjects - Side by side */}
            <div className="grid grid-cols-2 gap-2 mb-auto">
                <div className="border border-black p-1.5 bg-gray-50">
                    <p className="text-[8px] font-black uppercase text-gray-500 mb-1 border-b border-gray-200">Documents:</p>
                ...
                <div className="border border-black p-1.5 bg-gray-50">
                    <p className="text-[8px] font-black uppercase text-gray-500 mb-1 border-b border-gray-200">Subjects:</p>
                    <div className="flex flex-wrap gap-1">
                        {student.subjects?.slice(0, 4).map((sub, i) => (
                            <span key={i} className="text-[8px] font-bold border border-gray-300 px-1 bg-white uppercase">{sub}</span>
                        ))}
                    </div>
                </div>
            </div>
            ...
            {/* Footer: Signatures */}
            <div className="flex justify-between px-8 mt-4 pt-2 border-t border-gray-100">
                ...
                <div className="text-center">
                    <div className="w-20 border-b border-black mb-1"></div>
                    <p className="text-[8px] font-bold uppercase tracking-tighter">Principal / Seal</p>
                </div>
            </div>
        </div>
    );
    ...
    return (
        <div className="fixed inset-0 bg-gray-200 z-[100] overflow-y-auto pb-10 flex flex-col items-center">
            ...
            <div ref={printRef} className="w-full max-w-[210mm] bg-white p-4 shadow-xl">
                ...
                {/* Scissor Line - Compact */}
                <div className="no-print flex items-center justify-center my-4 opacity-30">
                    <div className="flex-1 border-b border-dashed border-gray-500"></div>
                    <span className="mx-4 text-gray-500 text-[8px] font-bold uppercase tracking-[8px]">CUT LINE</span>
                    <div className="flex-1 border-b border-dashed border-gray-500"></div>
                </div>
